...
import 'package:geco_mobile/modules/personal_cleaner/adapters/screens/widgets/room_card.dart';
  ...
  try {
    ...
    if (response.data['msg'] == 'OK') {
      for (var habitacion in response.data['data']) {
        // Filtra solo las habitaciones con id igual a 1
        if (habitacion['idUser'] == 1) {
